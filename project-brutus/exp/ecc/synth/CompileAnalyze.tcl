...
#---------------------------------------------------------
 ...
 set target_library NangateOpenCellLibrary_fast_conditional_ccs.db
 set link_library   NangateOpenCellLibrary_fast_conditional_ccs.db
...
#---------------------------------------------------------
 ...
 set link_library   NangateOpenCellLibrary_slow_conditional_ccs.db
 set link_library   [concat  $link_library dw_foundation.sldb]
 translate
...
# report_timing -delay min  > timing_min_fast_holdfixed_${type}.rpt
 ...
 set target_library NangateOpenCellLibrary_typical_conditional_ccs.db
 set link_library   NangateOpenCellLibrary_typical_conditional_ccs.db
 set link_library   [concat  $link_library dw_foundation.sldb]
 translate
...
#---------------------------------------------------------
 report_cell > cell_report_final_${modname}.rpt
